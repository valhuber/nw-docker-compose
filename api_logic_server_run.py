...
###############################################################################
#
#    This file initializes and starts the API Logic Server (v 09.01.18, July 24, 2023 13:48:35):
...
app_logger.info(f'Created July 24, 2023 13:48:35 at {str(current_path)}\n')
